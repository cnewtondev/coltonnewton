...
class MobileCard extends Component {
  ...
  update = (eventType) => {
    ...
    //   this.clientPosition.yPercentage = ((x - this.left) ) * 200 - 100;
    }
    // set range [-100,100]
  ...
  render() {
    return (
      <div className="parallax-tilt-effect-two"
        ...
        <div className="inner-element-three">
        ...
        <div className='mobileCardHr'/>
        <div className='inner-element-four'>
                    <div className="email fallow">
                        <Email className='cardIcon' style={{marginRight:'5px', marginTop:'5px !important'}}/>
                        <a className='cardEmail' href="mailto: coltonnewton89@gmail.com">coltonnew..</a>
                    </div>
